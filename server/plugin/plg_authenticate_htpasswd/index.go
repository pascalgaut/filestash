...
import (
	...
	"github.com/pascalgaut/filestash/server/plugin/plg_authenticate_htpasswd/deps/crypt/apr1_crypt"
	"github.com/pascalgaut/filestash/server/plugin/plg_authenticate_htpasswd/deps/crypt/md5_crypt"
	"github.com/pascalgaut/filestash/server/plugin/plg_authenticate_htpasswd/deps/crypt/sha256_crypt"
	"github.com/pascalgaut/filestash/server/plugin/plg_authenticate_htpasswd/deps/crypt/sha512_crypt"
	"net/http"
	"strings"
)
